...
const WebappUploads = () => (
    <div className="w-[220px] h-[270px] rounded-[26.667px] border border-opacity-30 border-[#004B80] bg-white p-5 flex flex-col justify-between">
        ...
        <div className="flex flex-col items-center">
            <div className="relative">
                ...
                {/* <div className="absolute top-0 left-4 bg-[#F3E8D9] rounded-full px-2 py-1 text-sm text-[#7B6000]">+12 added today</div> */}
            </div>
            <p className="text-4xl font-bold ">68</p>
        </div>
        {/* <div className="flex justify-center mt-2">
            <button className="text-[#015EA1] underline text-sm font-medium">Uploaded Notices &rarr;</button>
        </div> */}
    </div>
);
...
const NoticesUploaded = () => (
    <div className="w-full h-[270px] rounded-[26.667px] border border-opacity-30 border-[#004B80] bg-white p-5">
